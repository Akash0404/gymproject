...
def registerr(request):
    ...
    #     Lastname = request.POST.get('Lastname')
        # registerr = Registerr(Username=Username, Password=Password, Firstname=Firstname, Lastname=Lastname)
        # registerr.save()
...
def contact(request):
    if request.method == "POST":
        ...
        contact = Contact(name=name, email=email, Contact_no=Contact_no, subject=subject,messages=messages)
        contact.save()   
